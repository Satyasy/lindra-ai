...
- Kalau siswa MENGOREKSI/meRALAT ceritanya di sepanjang transkrip (mis. mula-mula "aku dipukul" lalu meralat "hampir dipukul, tapi dicegah"), pakai versi TERKOREKSI yang paling akhir — JANGAN terpaku pada pernyataan awal. Berlaku untuk semua field, cederaFisik, dan narrativeSummary: kalau ternyata tidak sampai kena, cederaFisik=false dan narasi menyebut "hampir ... tetapi dicegah", BUKAN "dipukul".
